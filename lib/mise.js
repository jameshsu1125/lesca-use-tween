...
exports.UnitCombiner = exports.InitTransformCombiner = exports.unitSplitter = void 0;
var hex2hsl_1 = require("./hex2hsl");
var useColor = ['backgroundColor', 'color', 'borderColor'];
var useTransform = ['scale', 'x', 'y', 'rotate'];
var functionName = { scale: 'scale', rotate: 'rotate', x: 'translateX', y: 'translateY' };
...
var InitTransformCombiner = function (style) {
    ...
    Object.entries(style).forEach(function (t) {
        ...
        if (isTransform.length > 0) {
            ...
            var matchKey = Object.entries(functionName).filter(function (e) { return e[0] === key_1; });
            var f = matchKey[0][1];
...
var UnitCombiner = function (e, u) {
    ...
    Object.entries(e).forEach(function (t) {
        ...
        if (unit === 'hsl') {
            ...
            var matchKey = Object.entries(functionName).filter(function (e) { return e[0] === key_2; });
            var f = matchKey[0][1];
