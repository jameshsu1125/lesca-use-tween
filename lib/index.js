...
define(["require", "exports", "lesca-object-tweener", "react", "./mise"], function (require, exports, lesca_object_tweener_1, react_1, mise_1) {
        ...
        var tranFrom = function () {
            ...
            if (!Object.keys(fromRef.current).length) {
                Object.entries(state).forEach(function (e) {
                    ...
                    var result = (0, mise_1.UnitSpliter)(classname, value);
                    if (result) {
    ...
    var TweenProvider = function (_a) {
        var children = _a.children, defalutStyle = _a.defalutStyle, tweenStyle = _a.tweenStyle, options = _a.options;
        var _b = useTween(defalutStyle), style = _b[0], setStyle = _b[1], destory = _b[2];
        (0, react_1.useEffect)(function () {
            setStyle(tweenStyle, options);
            return function () { return destory(); };
        }, [tweenStyle]);
        return react_1.Children.map(children, function (child) { return (0, react_1.cloneElement)(child, { style: style }); });
    };
