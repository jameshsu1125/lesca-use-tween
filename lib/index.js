...
var TweenProvider = function (_a) {
    var children = _a.children, initStyle = _a.initStyle, tweenStyle = _a.tweenStyle, options = _a.options;
    var _b = useTween(initStyle), style = _b[0], setStyle = _b[1], destroy = _b[2];
