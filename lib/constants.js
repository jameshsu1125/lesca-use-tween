...
var InitTransformCombiner = function InitTransformCombiner(style) {
  ...
  Object.entries(style).forEach(function (t) {
    ...
    if (isTransform.length > 0) {
      var _isTransform = _slicedToArray(isTransform, 1),
          _key = _isTransform[0];

      var f = funtionName[_key];
      var u = unitName[_key];
...
var UnitCombiner = function UnitCombiner(e, u) {
  ...
  Object.entries(e).forEach(function (t) {
    ...
    if (unit === 'hsl') {
      ...
      var _isTransform2 = _slicedToArray(isTransform, 1),
          _key2 = _isTransform2[0];

      var f = funtionName[_key2];
      var _u = unitName[_key2];
